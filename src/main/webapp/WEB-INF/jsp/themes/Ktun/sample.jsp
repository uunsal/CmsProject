...
<main role="main" class="flex-shrink-0">
    <div class="container">
        <div class="row">
        <div class="col-sm-10" style="min-height:300px;border-right:1px solid #ddd;">${page.contents}</div>
        <div class="col-sm-2">
            ...
            <div style="padding-top:7px;">
               <c:if test = '${setting.profilePhoto!=null}'>
                   <img src=${setting.profilePhoto} height="200" width="200" class="img-rounded">
               </c:if>
            <c:if test = '${setting.profilePhoto==null}'>
