    ...
    <script>
        ...
        app.controller('myAppcntrl', function ($scope, $http, $log, $location, $timeout, $window) {
            ...
            $scope.formu_gonder = function () {
                $scope.datas = {url:$scope.urls,user:{firstName:$scope.name,lastName:$scope.lname,email:$scope.email,unvan:$scope.unvan}};
...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-12 px-4">
            ...
            <ul style="margin-top: 50px;" class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Kullanıcılar</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Kullanıcı Ekle</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">Kullanıcı Duyuruları</a>
                </li>
            </ul>
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                    <div class="my-3 p-3 bg-white rounded shadow-sm">
                        <div class="kapsa border-bottom border-gray pb-2 mb-0" style="overflow: hidden;padding: 5px;">
                            <h6 class="" style="float:left;margin-top: 10px">Kullanıcı Ekle</h6>
                        </div>
                        <div ng-show="alertShow" class="alert alert-{{alert_type}} alert-dismissible fade show" role="alert">
                            {{alertContent}}

                        </div>
                        <form style="margin-top: 10px;" ng-submit="formu_gonder()">
                            <div class="form-group">
                                <label for="exampleInputUsername">Kullanıcının Adını Giriniz</label>
                                <input ng-model="name" type="username" class="form-control" id="exampleInputUsername" placeholder="Adı">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputUserlastname">Kullanıcının Soyadını Giriniz</label>
                                <input ng-model="lname" type="username" class="form-control" id="exampleInputUserlastname" placeholder="Soyadı">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Email Adresi</label>
                                <input ng-model="email" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Email adresi">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputUserlastname">Kullanıcının Ünvanını Giriniz</label>
                                <input ng-model="unvan" type="username" class="form-control" id="exampleInputUser" placeholder="Ünvan">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputUserlastname">Çalışma Url Giriniz</label>
                                <input ng-model="urls" type="runurl" class="form-control" id="exampleInputUrl" placeholder="Url">
                            </div>
